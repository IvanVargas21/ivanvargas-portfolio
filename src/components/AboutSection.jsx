...
const AboutSection = () => {
  return (
    <section className="flex flex-col justify-center items-start py-2 mb-20 sm:mb-16 lg:mb-10 lg:py-14 2xl:py-5 2xl:pt-10">
      <header className="flex justify-start items-center mb-5 gap-x-4 w-full sm:mb-8">
      ...
      <div>
        <div className="md:px-8">
          <p className="text-base sm:text-sm md:text-base lg:text-lg xl:text-xl 2xl:text-2xl font-light sm:font-thin text-justify mb-4">
          ...
          <p className="text-base sm:text-sm md:text-base lg:text-lg xl:text-xl 2xl:text-2xl font-light sm:font-thin text-justify mb-4 sm:mb-10">
